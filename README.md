...
Inspired by [Hotline Miami Mod Manager](https://github.com/cds-reis/hotline_miami_mod_manager). 

*(It didn't have Linux support, so I started working on this... 5 hours before they dropped a Linux build)*
